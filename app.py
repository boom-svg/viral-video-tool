...
<style>
    ...
    /* ===== 全局变量 - DeepSeek 配色 ===== */
    :root {
        --bg-primary: #0e1117;        /* 深邃黑 */
        --bg-secondary: #161b22;      /* 侧边栏背景 */
        --bg-card: #1c2128;           /* 卡片背景 */
        --accent-blue: #4d6bfe;        /* DeepSeek Blue 主色调 */
        --accent-purple: #7c3aed;     /* 紫色点缀 */
        --accent-gradient: linear-gradient(135deg, #4d6bfe 0%, #6366f1 100%);
    ...
    .stApp {
        ...
        background-image: 
            radial-gradient(circle at 50% 0%, rgba(77,107,254,0.08) 0%, transparent 50%),
            radial-gradient(circle at 100% 100%, rgba(124,58,237,0.05) 0%, transparent 30%);
        color: var(--text-primary);
        font-family: 'Inter', 'Source Han Sans SC', -apple-system, BlinkMacSystemFont, sans-serif;
    }
    ...
    h1, h2, h3, h4, h5, h6 {
        ...
        font-family: 'Inter', 'Source Han Sans SC', sans-serif !important;
...
def render_file_uploader():
    ...
    # 视频转音频提示
    with st.expander("💡 视频如何转音频？点击查看方法"):
        st.markdown("""
        **方法一：使用在线工具（推荐）**
        - [Apowersoft在线音频转换器](https://www.apowersoft.cn/online-audio-converter) - 免费，无需安装
        - [Zamzar](https://www.zamzar.com/convert/mp4-to-mp3/) - 国外工具，支持多种格式
